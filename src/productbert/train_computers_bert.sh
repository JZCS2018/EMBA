#!/bin/bash
# python train.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 5e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 3e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 8e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small.json --lr 1e-4
...
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_small_joint.json --lr 1e-4
# python train.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 5e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 3e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 8e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium.json --lr 1e-4
...
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_medium_joint.json --lr 1e-4
# python train.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 5e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 3e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 8e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large.json --lr 1e-4
...
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_large_joint.json --lr 1e-4
# python train.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 5e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 3e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 8e-5
# python train.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 5e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 3e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 8e-5
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-4
# python train_random.py --device 0 -c configs/BERT/computers/config_computers_xlarge.json --lr 1e-4
