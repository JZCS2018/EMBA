#!/bin/bash
python train.py --device 0 -c configs/BERT/dblpscholar/config_dblpscholar_joint.json --lr 1e-5
python train.py --device 0 -c configs/BERT/dblpscholar/config_dblpscholar_joint.json --lr 5e-5
